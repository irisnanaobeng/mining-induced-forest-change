...
palette <- list(
 mining = "#FF0000",               # deeper mining red
  ...
  no_change = "#D9D9D9",           # grey90 - no change
  decrease = "#B2182B",            # strong red for NDVI decrease
  increase = "#228b22",            # strong green for NDVI increase
  background = "#C1FFC1",          # darkseagreen1 - warm background
  study_area = "#8B0000",          # darkred - study area highlight
  ghana_bg = "#FFEBCD"             # bisque - Ghana background
)
