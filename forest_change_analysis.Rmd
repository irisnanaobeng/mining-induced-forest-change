...
- **Mining-Induced Bare Soil (Red)**: Areas of active mining showing complete vegetation removal.

- **Degraded/Disturbed Forest (Yellow)**: Forest areas under stress from mining activities; reflects indirect mining impacts such as soil and water pollution, partial canopy loss, or nearby mining disturbance.

- **No Change (Light Cream)**: Stable forest vegetation unaffected by mining


The workflow demonstrates the effectiveness of Sentinel-2 NDVI analysis for mapping mining impacts on forest ecosystems.