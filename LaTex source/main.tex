...
Mining-induced forest degradation has become an increasing environmental concern in tropical regions due to the expansion of both artisanal and large-scale mining activities. In Ghana, the Pra River Basin has experienced significant environmental pressure resulting from vegetation loss, land disturbance, and ecosystem degradation associated with gold mining. Effective approaches are therefore required to monitor changes in forest condition and identify the spatial extent of mining-related environmental impacts.

This study assessed mining-induced forest degradation within the Pra River Basin using a multi-temporal remote sensing approach based on Sentinel-2 satellite imagery acquired in 2018, 2020, and 2022. The analysis integrated Normalized Difference Vegetation Index (NDVI) classification with spectral distance analysis and fuzzy classification techniques to evaluate changes in vegetation condition over time and detect areas affected by mining activity.

The results showed a progressive decline in vegetation condition across the study area, with substantial reductions observed between 2020 and 2022. NDVI change detection indicated that approximately 13.4\% of the study area experienced vegetation decline, while only 4.5\% showed vegetation recovery. Spectral distance analysis further revealed gradual ecological deterioration in areas surrounding active mining zones, demonstrating that degradation extended beyond areas of direct vegetation removal.

The findings suggest that combining NDVI with spectral distance analysis provides a more comprehensive approach for detecting both direct forest loss and subtle changes in vegetation condition than single-index approaches alone. The study contributes to understanding mining-related environmental change in Ghana and demonstrates the usefulness of integrated remote sensing methods for monitoring forest degradation in tropical landscapes.

\textbf{Keywords:} Forest degradation; Mining; Remote sensing; NDVI; Spectral distance analysis; Sentinel-2; Pra River Basin; Ghana.
...
By 2020, localized areas of lower NDVI had begun to appear, particularly within the central portion of the basin and in areas associated with mining activity. Some reductions were also visible near drainage networks and river corridors, indicating the early stages of vegetation disturbance.
...
The NDVI difference map for 2018--2022 shows the spatial pattern of vegetation change within the Pra River Basin. Negative NDVI values, shown in shades of red, indicate areas where vegetation condition declined between 2018 and 2022. Darker red tones represent stronger reductions in vegetation condition, while lighter pink areas indicate relatively minor decreases in NDVI values. Positive values, shown in green, indicate areas where vegetation condition improved, while values close to zero represent areas with little or no change.

The map shows that vegetation decline was more widespread than vegetation increase. Areas of NDVI decrease are distributed across much of the basin, with stronger reductions occurring around river corridors and mining-influenced zones. This suggests that vegetation disturbance was spatially associated with areas affected by mining activity.
...
The spectral distance analysis shows that the spectral properties of the landscape became progressively more similar to the mining centroid between 2018 and 2022. The change in mining spectral condition is shown in Figure~\ref{fig:mining_spectral}.

In 2018, most pixels exhibited relatively large distances from the mining centroid, indicating that mining surfaces occupied only a limited proportion of the study area. By 2020, the distribution shifted slightly toward lower distances, suggesting an increase in mining-related surfaces. The strongest shift occurred in 2022, when a larger proportion of pixels exhibited low spectral distance to the mining centroid. This indicates that mining-related land cover expanded substantially during the study period.
...
The scatter plot further illustrates the distribution of landscape pixels within spectral space using red and near-infrared reflectance values. The mining centroid, shown as the red diamond, represents the reference mining spectral signature derived from the 2018 dataset. Pixels located closer to this centroid exhibit greater spectral similarity to mining-related surfaces, whereas pixels located farther away represent less disturbed land-cover conditions. The broader spread observed in later years suggests increasing spectral heterogeneity associated with mining expansion.The broader spread of pixels observed in later years suggests increasing spectral heterogeneity associated with mining expansion.
...
The spectral analysis of forest condition reveals an opposite trend to that observed for mining. The change in forest spectral condition is shown in Figure~\ref{fig:forest_spectral}.
...
The results demonstrate that vegetation condition declined substantially between 2018 and 2022 within the Pra River Basin. NDVI analysis revealed widespread reductions in vegetation condition, particularly around river corridors and areas affected by mining activity.

Mining activity expanded considerably during the study period and was concentrated within riverine environments. At the same time, spectral distance analysis showed that remaining forest areas became progressively less similar to the 2018 healthy forest reference condition.

These findings indicate that mining contributed not only to direct vegetation removal but also to broader forest degradation across the surrounding landscape. The combined use of NDVI and spectral distance analysis therefore provided complementary evidence of both land-cover change and gradual ecological deterioration within the study area.
