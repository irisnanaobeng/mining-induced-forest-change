...
```{r temporal-plot-function-2, echo=TRUE, message=FALSE}
...
```{r generate-temporal-plots-final, fig.width=16, fig.height=12, echo=FALSE, message=FALSE}
# Generate temporal analysis plot
temporal_plot <- plot_temporal_distance(fuzzy_2018, fuzzy_2020, fuzzy_2022, mining_class)

# Save plot
ggsave("maps/temporal_mining_analysis.png", temporal_plot, 
...
3. The boxplots show that distances are higher and more spread out in 2022, meaning mining disturbance has expanded and become more varied across the area.

**Integration with NDVI Findings**: These results complement the NDVI analysis, providing spectral evidence of mining expansion that corresponds with vegetation decline observed.
